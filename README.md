# CompanyOS, an operating system in markdown
...
2. Adopt the `AGENTS.md` (or rename it to your tool's preferred filename, such as CLAUDE.md or .cursorrules). It's intentionally minimal; layer your project specifics on top, don't replace it.
...
CompanyOS is a Tome from [TomeVault](https://tomevault.io), the neutral referee that keeps AI agents behaving the way you taught them as the models underneath keep changing. We grade the files that steer your agents on whether they load, stay clear, run safe, and hold up across models, then keep that verdict true as the tools change. Scan your own instruction files and read the verdict at [tomevault.io/scan](https://tomevault.io/scan).
